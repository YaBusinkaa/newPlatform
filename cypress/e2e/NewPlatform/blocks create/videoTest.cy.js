describe('Video block testing', () => {
    ...
    it('Основной сценарий - создание блока видео', () => {

        cy.server();
        
        const fixturePath = 'testVideo.mp4';
        const mimeType = '/mp4';

        cy.get('input[id="icon-button-file"]')
            .uploadFile(fixturePath, mimeType);
